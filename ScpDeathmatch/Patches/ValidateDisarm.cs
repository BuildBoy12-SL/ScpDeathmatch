    ...
    internal static class ValidateDisarm
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            newInstructions.InsertRange(index, new CodeInstruction[]
            {
                ...
                new(OpCodes.Callvirt, PropertyGetter(typeof(Config), nameof(Config.Disarming))),
                new(OpCodes.Callvirt, PropertyGetter(typeof(DisarmingConfig), nameof(DisarmingConfig.DisarmAtDistance))),
                new(OpCodes.Brfalse_S, returnFalseLabel),
            });
            ...
            newInstructions.InsertRange(index, new CodeInstruction[]
            {
                ...
                new(OpCodes.Callvirt, PropertyGetter(typeof(Plugin), nameof(Plugin.Config))),
                new(OpCodes.Callvirt, PropertyGetter(typeof(Config), nameof(Config.Disarming))),
                new(OpCodes.Callvirt, PropertyGetter(typeof(DisarmingConfig), nameof(DisarmingConfig.DropItems))),
                new(OpCodes.Brfalse_S, returnTrueLabel),
            });
